...
public class GetResourceCommandRequest {
    public static ApplicationCommandRequest GET_RESOURCE_COMMAND_REQUEST() {
        return ApplicationCommandRequest.builder()
                .name(SlashCommandCommon.GET_RESOURCE_COMMAND)
