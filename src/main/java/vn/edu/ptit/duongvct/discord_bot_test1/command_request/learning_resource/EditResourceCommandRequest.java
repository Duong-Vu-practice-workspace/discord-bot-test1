...
public class EditResourceCommandRequest {
    public static ApplicationCommandRequest EDIT_RESOURCE_COMMAND_REQUEST() {
        return ApplicationCommandRequest.builder()
                .name(SlashCommandCommon.EDIT_RESOURCE_COMMAND)
